...
knitr::include_graphics("img/down-arrow.png")
```
...
```{r, out.width="150px", echo=FALSE}
knitr::include_graphics("img/right-arrow.png")
```
...
```{r out.width="650px", out.extra='style="background:none; border:none;"', echo=FALSE}
knitr::include_graphics("img/rstudio-projects1.png")
```
...
```{r out.width="650px", out.extra='style="background:none; border:none;"', echo=FALSE}
knitr::include_graphics("img/rstudio-projects2.png")
```
