...
plot(PCA_BRCA$x[, c(1, 2)],
  col = color_by_type(ER_status),
  main = "ER status", pch = 19
)
...
plot(PCA_BRCA$x[, c(1, 2)],
  col = color_by_type(PR_status),
  main = "PR status", pch = 19
)
...
```{r}
colors <- color_by_type(unique(HER2_status))
diag <- unique(HER2_status)
plot(PCA_BRCA$x[, c(1, 2)],
  col = color_by_type(HER2_status),
  main = "HER2 status", pch = 19
)
